...
*/
    ...
    def add_section_to_file_ok(self):
    ...
    def add_section_to_section_ok(self):
    ...
    def add_section_double_parents(self):
        section = FileSection.objects.get(name='invariant outer loop')
        file = File.objects.get(name='test_file.c')
    ...
    def add_section_to_section_wrong_mark(self):
        section = FileSection.objects.get(name='invariant outer loop')
    ...
    def add_section_to_file_wrong_mark(self):
        file = File.objects.get(name='test_file.c')
    ...
    def add_section_to_section_not_contained(self):
        section = FileSection.objects.get(name='invariant outer loop')
    ...
    def add_section_negative_line(self):
        file = File.objects.get(name='test_file.c')
    ...
    def add_section_begin_greater_than_end(self):
        file = File.objects.get(name='test_file.c')
